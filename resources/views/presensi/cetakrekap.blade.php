...
<body class="A4 landscape">
    ...
    <section class="sheet padding-10mm">
            ...
            <tr>
                ...
                <td>
                    <span id="title">
                        ...
                        UNIVERSITAS ANNUQAYAH<br>
                    </span>
                    <span><i>Jl. Bukit Lancaran Pondok Pesantren Annuqayah, Guluk-Guluk, Sumenep, Guluk Guluk Timur I, Guluk-guluk, Kec. Guluk-Guluk, Madura, Jawa Timur 69463</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td></td>
                <td style="text-align: right">Sumenep, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
